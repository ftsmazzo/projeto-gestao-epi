...
export function EquipeSection({
  ...
  async function onTransfer(member: OrganizationMember) {
    ...
    const ok = window.confirm(
      `Transferir o administrador geral para ${member.user.name} (${member.user.email})?\n\nVoce passara a ser Administrador. Faca logout e login de novo para atualizar o papel na sessao.`,
    );
    if (!ok) return;
    setSaving(true);
    setError(null);
  ...
  return (
    <div className="settings-section">
      <header className="settings-section__head">
        <h2 className="settings-section__title">Equipe da gestao</h2>
        <p className="page-lead">
          Usuarios que acessam a consultoria. O administrador geral (OWNER)
          transfere o controle e adiciona administradores e membros. O convite
          sai por e-mail e WhatsApp, com resposta para o contato de suporte.
        </p>
      </header>
      ...
      {oneTimeAccess ? (
        <section className="dash-panel" aria-label="Acesso temporario">
          <h3 className="dash-panel__title">Acesso / convite</h3>
          <p className="page-lead">
      ...
      {canManage ? (
        <section className="dash-panel" aria-labelledby="add-member-title">
          <h3 id="add-member-title" className="dash-panel__title">
            Adicionar usuario
          </h3>
      ...
      <section className="dash-panel" aria-labelledby="team-list-title">
        <h3 id="team-list-title" className="dash-panel__title">
