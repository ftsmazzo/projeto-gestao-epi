...
export const DEFAULT_EPI_NEED_SEEDS: DefaultEpiNeedSeed[] = [
  ...
  },
  {
    ...
    aliases: ['capa de chuva', 'capa impermeavel'],
    usefulLifeValue: 3,
    usefulLifeUnit: EpiUsefulLifeUnit.MESES,
  },
  {
    name: 'Calca de Seguranca',
    category: EpiCategory.TRONCO,
    description: 'Calca de protecao / seguranca para trabalho.',
    aliases: [
      'calca de seguranca',
      'calca de protecao',
      'calça de segurança',
  ...
  {
    name: 'Camisa de Protecao',
    category: EpiCategory.TRONCO,
    description: 'Camisa / jaleco de protecao.',
    aliases: [
      'camisa de protecao',
      'camisa de segurança',
      'camisa de seguranca',
  ...
  },
  {
    ...
    category: EpiCategory.MAOS,
    description: 'Luva de protecao generica (tipo definido no estoque/CA).',
    aliases: ['luva de protecao'],
    usefulLifeValue: 1,
    usefulLifeUnit: EpiUsefulLifeUnit.MESES,
  },
  {
    name: 'Luva Latex',
    category: EpiCategory.MAOS,
    description: 'Luva de latex / procedimento.',
    aliases: [
      'luva latex',
      'luva de latex',
      'luva látex',
  ...
  {
    name: 'Touca Tipo Arabe',
    category: EpiCategory.CABECA,
    description: 'Touca tipo arabe / protetor de pescoco e nuca.',
    aliases: [
      'touca arabe',
      'touca tipo arabe',
      'touca árabe',
      'touca tipo árabe',
      'touca arabe de protecao',
    ],
    usefulLifeValue: 6,
    usefulLifeUnit: EpiUsefulLifeUnit.MESES,
  },
